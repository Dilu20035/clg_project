...
<div class="nav">
        ...
        <ul class="nav-list">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="ml-analyzer.php">ML-Analyzer</a>
                </li>
                <li class="nav-item">
    ...
    <header>
        <div class="container1">
            <div class="content">
                <h1>ML-Analyzer:</h1><h2><span id="element"></span></h2>
                <p>Welcome to <i><b>Machine-Learning Disease Analyzer</b></i>. Experience precision in diagnostics: Our AI-driven platform swiftly identifies diseases from reported symptoms, revolutionizing healthcare.</p>
                <a href="https://hda-ml.streamlit.app/"> <button class="btn2">Let's Launch the App!</button></a>
            </div>
            <div class="image">
    ...
    <div class="spotlight"><h2 id="spotlight">DEMO-VIDEO</h2><h2 id="spotlight2">for ML-Analyzer</h2></div>
    <main>
        <div class="img1-vid">
        <video autoplay loop muted preload="auto">
            <source src="img3.webm" type="video/webm">
    ...
    <footer class="footer">
        <div class="foott1">
            <div class="colu1">
                <p><a href="ml-analyzer.php" class="logoo">🩺HDA</a></p>
            </div>
            <div class="colu2">
                <h4>QUICK MENU</h4>
                <ul class="foo-list">
    ...
    <script>
        ...
        var typed = new Typed('#element', {
            strings: ['Select Symptoms', 'Identify Disease','Present Precautions'],
            typeSpeed: 100,
            loop: true,
        });

        const animationPath = 'https://lottie.host/c85a7b70-8aa8-4c76-9e3d-0b2e234e6617/23a96Ttj7q.json';
        // Load the animation
        const animData = {
