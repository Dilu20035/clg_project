...
<div class="nav">
    ...
    <header>
        <div class="container1">
            <div class="content">
                ...
                <button class="btn2">Hey👋🏻 <b><?php echo $res_Uname ?></b>, Welcome back!</button></a>
            </div>
            <div class="image">
    ...
    <footer class="footer">
        <div class="foott1">
            <div class="colu1">
                <p><a href="home.php" class="logoo">🩺HDA</a></p>
            </div>
            <div class="colu2">
                <h4>QUICK MENU</h4>
                <ul class="foo-list">
    ...
    <script>
        ...
        const animationPath = 'https://lottie.host/e2e0fc94-8e7c-4e23-9004-758672f8c271/UYOj5rmAIz.json';
        // Load the animation
        const animData = {
