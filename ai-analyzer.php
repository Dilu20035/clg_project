...
<div class="nav">
        ...
        <ul class="nav-list">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="ai-analyzer.php">AI-Analyzer</a>
                </li>
    ...
    <header>
        <div class="container1">
            <div class="content">
                <h1>AI-Analyzer:</h1><h2><span id="element"></span></h2>
                <p>Welcome to <i><b>Artificial-Intelligence Disease Analyzer</b></i>. Experience precision in diagnostics: Our AI-driven platform swiftly identifies diseases from reported symptoms, revolutionizing healthcare.</p>
                <a href="https://hda-ai.streamlit.app/"> <button class="btn2">Let's Launch the App!</button></a>
            </div>
            <div class="image">
    ...
    <div class="spotlight"><h2 id="spotlight">DEMO-VIDEO</h2><h2 id="spotlight2">for AI-Analyzer</h2></div>
    <main>
        <div class="img1-vid">
        <video autoplay loop muted preload="auto">
            <source src="img2.webm" type="video/webm">
    ...
    <footer class="footer">
        <div class="foott1">
            <div class="colu1">
                <p><a href="ai-analyzer.php" class="logoo">🩺HDA</a></p>
            </div>
            <div class="colu2">
                <h4>QUICK MENU</h4>
                <ul class="foo-list">
    ...
    <script>
        ...
        var typed = new Typed('#element', {
            strings: ['Input Data', 'Analyze Condition','Outline Disease','Get Precautions'],
            typeSpeed: 100,
            loop: true,
        });

        const animationPath = 'https://lottie.host/e18f55ca-641c-4712-a537-abbe2d690a6d/zXk75Sy6jG.json';
        // Load the animation
        const animData = {
